...
phaseFFT_length = 8192; %make sure this is > data_buffer_size and is a power of 2
...
while true
    ...
    four_frames = combined(frame_index:(frame_index+47) , :);
    frame_index = frame_index+48; 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%     disp(ydata); %used to be disp(ydata');
    ...
    if plot_toggle == true  
        ...
        title(['Phase FFT, freq = ',num2str(norm_max_mag)]);
        xlim([0  3.5]);
    else
        subplot(2,1,2);
